...
def encode_record(s: str) -> bytes:
    """UTF-8 encode a record line to bytes for the byte store."""
...
def to_b64(s: str) -> str:
    """Encode text to a transport-safe base64 ASCII string."""
    raw = s.encode("utf-8")
    return base64.b64encode(raw).decode("ascii")


def from_b64(s: str) -> str:
    """Decode a base64 ASCII string back to text."""
